...
typedef gint (*RTPSourceRtxSrc) (RTPSource *src, guint8 payload, gpointer user_data);
...
//  gchar        *bye_reason;
  ...
  gboolean     send_nack;  //for #NACK support
  GArray      *nacks;
...
* @see
*/
void            rtp_source_register_nack       (RTPSource *src, //for #NACK support
                                                guint16 seqnum);
/**
