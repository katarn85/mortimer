...
typedef gint (*RTPSessionRtxSrc) (RTPSession *sess, guint8 payload, gpointer user_data);
...
struct _RTPSession {
 ...
 guint         probation;
  ...
  //ONLY FOR THE CASE OD SSRC multiplexing
  gint8	       main_ssrc_pt;
  guint32      main_ssrc;
  guint32      rtx_ssrc;
...
void         	rtp_session_set_rtx_src_callback   (RTPSession *sess,
						    RTPSessionClockRate callback,
						    gpointer user_data);
...
* @brief
*
* @param[in]/[out]	: RTPSession *sess,guint32 ssrc,guint16 seqnum,GstClockTime max_delay
* @return		: gboolean
* @warning		: None
* @exception		: None
* @see
