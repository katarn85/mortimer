...
struct _GstRtpBinClass {
  ...
  gboolean    (*request_rtx_map)      (GstRtpBin *rtpbin, guint session);   //for #RET change
  gboolean    (*request_fid_map)      (GstRtpBin *rtpbin, guint session);   //---------------
  gboolean    (*request_fec_map)      (GstRtpBin *rtpbin, guint session);   //FEC changes
  ...
  void        (*remove_internal_session) (GstRtpBin *rtpbin, gint session_id); //for #RET change
