...
gboolean rtp_fecjitter_buffer_insert(RTPJitterBuffer *jbuf, RTPJitterBufferItem * item, gint *percent);
RTPJitterBufferItem *fec_jitter_buffer_pop (RTPJitterBuffer * jbuf, gint * percent);
// -- FEC Changes Bookkeeping.
