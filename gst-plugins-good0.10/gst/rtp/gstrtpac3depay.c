...
GST_STATIC_PAD_TEMPLATE ("src",
    GST_PAD_SRC,
    GST_PAD_ALWAYS,
    GST_STATIC_CAPS ("audio/x-ac3; " "audio/x-eac3 ")
    );
...
if ((str = gst_structure_get_string (structure, "encoding-name"))) {
    ...
    goto invalid_mode;
/*********************************/
  srccaps = gst_caps_new_simple (type, NULL);
...
invalid_mode:
  {
    GST_ERROR_OBJECT (rtpac3depay, "invalid encoding-name");
    return FALSE;
  }
/******************************/
}
