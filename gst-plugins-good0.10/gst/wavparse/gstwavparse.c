...
#ifndef GST_EXT_VD_WAVPARSE  /* VD decoder do not handle byte format duration query */
...
#ifndef GST_EXT_VD_WAVPARSE  /* VD decoder do not handle duration query with byte format */
