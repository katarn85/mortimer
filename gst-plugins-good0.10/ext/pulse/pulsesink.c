...
#ifndef __TIZEN__ /* Tizen will disable this */
#define ENABLE_VOL_PROP
#endif
...
enum
{
  ...
  PROP_DEVICE,
  PROP_DEVICE_NAME,
#ifdef ENABLE_VOL_PROP
  PROP_VOLUME,
#endif /* ENABLE_VOL_PROP */
  PROP_MUTE,
  PROP_CLIENT,
...
gst_pulseringbuffer_start (GstRingBuffer * buf)
{
  ...
  /* Temporary fix for a deadlock between gst_pulsesink_get_time 
   * and mainloop_enter_defer_cb, due to diffrent order of taking
   * Pulse Audio's main loop mutex and GStreamer's element mutex. */
#if 0 
