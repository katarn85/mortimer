...
#define D _config_edd
   ...
   ELM_CONFIG_VAL(D, T, page_scroll_threshold, T_INT);
...
_config_load(void)
{
   ...
   _elm_config->page_scroll_threshold = 5;
 ...
 */
   ...
   s = getenv("ELM_PAGE_SCROLL_THRESHOLD");
   if (s) _elm_config->page_scroll_threshold = _elm_atof(s);
