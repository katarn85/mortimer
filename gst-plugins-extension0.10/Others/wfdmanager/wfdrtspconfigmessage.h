...
typedef struct {
  /* TODO : When implement flush-play/flush-pause, need some more fields */
  WFDPlaybackState playback_state;
  guint64 flush_timing;
} WFDPlaybackControl;
#endif
...
#ifdef ENABLE_WFD_EXTENDED_FEATURES
  WFDBufferLen *buf_len;
  WFDAudioReport *audio_report;
  WFDBufferVol *buf_vol;
  WFDDongleUpgrade *dongle_upgrade;
  WFDRenameDongle *rename_dongle;
  WFDPlaybackControl *playback;
#endif
