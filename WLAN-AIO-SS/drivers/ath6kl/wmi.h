...
/* merge from olca mainline for align command id - start */
	...
	WMI_SET_DA_RETRY_LIMIT_CMDID,
	WMI_SET_SWOL_PULSE_TEST,
	WMI_SET_USB_CUT_CMDID,
...
struct wmi_set_da_retry_limit_cmd {
	u32 retry_limit;
} __packed;

struct wmi_usb_cut_cmd {
	u32 timeout;
} __packed;
