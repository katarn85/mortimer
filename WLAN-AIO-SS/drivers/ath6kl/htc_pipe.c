...
#ifdef PRE_ALLOC
struct htc_packet local_htc_packet[HTC_PACKET_CONTAINER_ALLOCATION];
#endif
...
#undef DELIMITER
	...
	if (htc_hdr->eid >= ENDPOINT_MAX ||
		(htc_hdr->eid != ENDPOINT_0 && ep->ep_cb.rx == NULL)) {
		//ath6kl_dbg(ATH6KL_DBG_HTC, // by max.park for a test
		printk(KERN_ERR
