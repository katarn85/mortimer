...
//for HW clock by max.park 2014-12-11
#ifdef CONFIG_HW_CLOCK
#include <trace/early.h>
#endif

/*Do memory pre-alloc for Rx bundle and cookie*/
#define PRE_ALLOC 1
...
//#define __BUILD_VERSION_ (5.0.1.45_0401)
#define __BUILD_VERSION_ (5.0.1.25)
...
#ifndef ATH6KL_MODULEDSRC_DEF_MODE
#define ATH6KL_MODULEDSRC_DEF_MODE	(0)
#endif
...
#ifndef ATH6KL_DEVNAME_DEF_DSRC
#define ATH6KL_DEVNAME_DEF_DSRC		"dsrc%d"
#endif
 ...
 */
/* disable NL80211_WIPHY_FEATURE_SCAN_FLUSH for wlan0 scan flush */
...
/* scan time out */
#define ATH6KL_SCAN_TIMEOUT_LONG (20 * HZ)  /* in sec. */
#define ATH6KL_SCAN_TIMEOUT_ONE_CON (20 * HZ)
#define ATH6KL_SCAN_TIMEOUT_SHORT (15 * HZ) /* in sec. */
...
/* 802.11p OCB command */
#define ATH6KL_IOCTL_STANDARD04		(SIOCDEVPRIVATE+4)
...
enum ath6kl_ocb_channel_op_type {
	ATH6KL_OCB_CHANNEL_OP_TX = 0,
	ATH6KL_OCB_CHANNEL_OP_RX = 1,
	MAX_ATH6KL_OCB_CHANNEL_OP,
};

struct ath6kl_ocb_channel_op {
	u8 type;
	union {
		struct {
			/* Default channel */
			...
			u16 tx_power;
			u16 tx_rate;
                        struct wmi_ocb_qos_params qos_params[WMM_NUM_AC];
		} tx_op;
		struct {
			u16 rx_channel;
			u8 rx_stats;
...
extern unsigned int dongle_type;	// for external-dongle by max.park
extern char version_string[VERSION_STRING_LENGTH];	// for UI display version
