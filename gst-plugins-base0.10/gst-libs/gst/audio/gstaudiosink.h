...
typedef gboolean (*render_started_cb)(GstAudioSink* sink, GstClockTime start_time);
/**
 * GstAudioSink:
 * 
 * Opaque #GstAudioSink.
...
struct _GstAudioSink {
  ...
  /* to measure the render delay */
  GstClockTime render_requested;
  GstClockTime render_started;
  render_started_cb started_cb;
  gboolean render_delay_updated;
  guint64 sum_of_written_bytes;
