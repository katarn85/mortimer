...
gst_video_format_from_fourcc (guint32 fourcc)
{
  switch (fourcc) {
    ...
    case GST_MAKE_FOURCC ('S', 'V', '2', '1'):
      return GST_VIDEO_FORMAT_SV21;
    case GST_MAKE_FOURCC ('U', 'M', '1', '2'):
      return GST_VIDEO_FORMAT_UM12;
...
gst_video_format_to_fourcc (GstVideoFormat format)
{
  ...
  switch (format) {
    ...
    case GST_VIDEO_FORMAT_STV0:
      return GST_MAKE_FOURCC ('S', 'T', 'V', '0');
    case GST_VIDEO_FORMAT_STV1:
      return GST_MAKE_FOURCC ('S', 'T', 'V', '1');
    ...
    case GST_VIDEO_FORMAT_SV21:
      return GST_MAKE_FOURCC ('S', 'V', '2', '1');
    case GST_VIDEO_FORMAT_UM12:
      return GST_MAKE_FOURCC ('U', 'M', '1', '2');
#endif
    default:
      return 0;
  }
