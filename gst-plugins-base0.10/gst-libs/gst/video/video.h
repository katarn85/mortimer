 ...
 * @GST_VIDEO_FORMAT_STV0: a custom format, actually it is planar 4:2:0 YUV
 * @GST_VIDEO_FORMAT_STV1: a custom format, actually it is planar 4:2:0 YUV
...
, GST_VIDEO_FORMAT_ST12,
  ...
  GST_VIDEO_FORMAT_SV21,
  GST_VIDEO_FORMAT_UM12
#endif
} GstVideoFormat;
