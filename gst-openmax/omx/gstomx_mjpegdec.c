...
GSTOMX_BOILERPLATE (GstOmxMjpegDec, gst_omx_mjpegdec, GstOmxBaseVideoDec,
    GST_OMX_BASE_VIDEODEC_TYPE);

GSTOMX_SIMPLE_BOILERPLATE (GstOmxUhdMjpegDec, gst_omx_uhd_mjpegdec, GstOmxBaseVideoDec,
    GST_OMX_BASE_VIDEODEC_TYPE);
...
type_base_init (gpointer g_class)
{
  ...
  gst_element_class_set_details_simple (element_class,
      "OpenMAX IL Mjpeg decoder",
      "Codec/Decoder/Video",
      "Decodes video in MJPEG format with OpenMAX IL", "Felipe Contreras");
