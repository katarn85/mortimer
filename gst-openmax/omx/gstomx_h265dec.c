...
GSTOMX_BOILERPLATE (GstOmxH265Dec, gst_omx_h265dec, GstOmxBaseVideoDec,
...
type_base_init (gpointer g_class)
{
  ...
  gst_element_class_set_details_simple (element_class,
      "OpenMAX IL H.265/HEVC video decoder",
      "Codec/Decoder/Video",
      "Decodes video in H.265/HEVC format with OpenMAX IL", "Felipe Contreras");
...
type_instance_init (GTypeInstance * instance, gpointer g_class)
{
  ...
  omx_base->compression_format = OMX_VIDEO_CodingHEVC;
