...
static GstQueryTypeDefinition standard_definitions[] = {
  ...
  {GST_QUERY_RESOURCE, "resource", "Resource Query", 0},
...
structure = gst_structure_id_new (GST_QUARK
     (QUERY_RESOURCE),
     GST_QUARK (QUERY_RESOURCE), G_TYPE_POINTER,
     resources, NULL);

query = gst_query_new (GST_QUERY_RESOURCE,structure);
