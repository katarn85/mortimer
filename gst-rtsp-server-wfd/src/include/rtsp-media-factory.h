...
/* Following declaration is moved to rtsp-server-common.h to expose it to libmm-wfd. */
...
void                  gst_rtsp_media_factory_set_srcbin (GstRTSPMediaFactory * factory, GstElement *srcbin);
void                  gst_rtsp_media_factory_set_connection_mode   (GstRTSPMediaFactory *factory,
                                                                    gint mode);
